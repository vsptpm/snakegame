...
class Game():
  ...
  def drawScore(self, score):
    scoreSurf = self.BASICFONT.render('Your Score is : %s' % (score), True, Config.WHITE)
  ...
  def draw(self):
    ...
    #here we'll draw our snake, grid, apple and score
    self.drawGrid()
    self.drawWorm()
    self.drawApple()
  ...
  def displayGameOver(self):
      ...
      overSurf = gameOverFont.render('OVER', True, Config.GREEN)
